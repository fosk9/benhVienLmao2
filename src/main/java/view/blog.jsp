...
<%
  ...
  List<Blog> recentPosts = dao.getRecentPosts(4);
%>
<!doctype html>
...
<main>
  ...
  <form action="add_blog.jsp" method="get" style="position: fixed; bottom: 30px; left: 30px; z-index: 9999;">
    <button class="write-btn" type="submit">+</button>
  </form>
      ...
      <div class="row">
        <div class="col-lg-8 mb-5 mb-lg-0">
          <div class="blog_left_sidebar">
            <article class="blog_item" style="margin-bottom: 40px;">
              <c:forEach var="blog" items="${blogs}">
                <div class="blog_item">
                  ...
                  <div class="blog_details">
                    <a class="d-inline-block" href="blog_details.jsp?bid=${blog.id}">
                      <h2>${blog.title}</h2>
                    </a>
        ...
        <div class="col-lg-4">
          <div class="blog_right_sidebar">
            ...
            <aside class="single_sidebar_widget popular_post_widget">
              ...
              <% for (Blog b : recentPosts) { %>
              <div class="media post_item">
                <img src="<%= b.getImageUrl() %>" alt="post" style="width: 80px; height: 80px; object-fit: cover;">
                <div class="media-body">
                  <a href="blog_details.jsp?bid=<%= b.getBlogId() %>">
                    <h3 style="color: #2d2d2d;"><%= b.getTitle() %></h3>
                  </a>
                  <p><%= b.getDate() != null ? b.getDate().format(java.time.format.DateTimeFormatter.ofPattern("MMM dd, yyyy")) : "" %></p>
                </div>
              </div>
              <% } %>
            </aside>
