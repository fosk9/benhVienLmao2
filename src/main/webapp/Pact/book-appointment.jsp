...
<head>
    ...
    <style>
        ...
        .big-form label, .big-form input, .big-form select, .big-form button {
            font-size: 1.2rem;
        }
        ...
        .total-price-section .price-display {
            font-size: 1.3rem;
            color: #28a745;
        }
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-xl-2 col-lg-2 col-md-1">
                    <div class="logo">
                        <a href="<c:url value='${sessionScope.patientId != null ? "/pactHome" : "/index"}'/>">
                ...
                <div class="col-xl-10 col-lg-10 col-md-10">
                    <div class="menu-main d-flex align-items-center justify-content-end">
                        ...
                        <div class="header-right-btn f-right d-none d-lg-block ml-15">
                            <c:choose>
                                <c:when test="${sessionScope.patientId != null}">
                                    <a href="<c:url value='/logout'/>" class="btn header-btn">Logout</a>
                                </c:when>
                                <c:otherwise>
        ...
        <form action="<c:url value='/book-appointment'/>" method="post" class="big-form" id="appointmentForm">
            ...
            <div class="form-group mb-4">
                ...
                <input type="date" class="form-control" id="appointmentDate" name="appointmentDate" required
                       value="${formData.appointmentDate != null ? formData.appointmentDate : param.appointmentDate}">
            ...
            <div class="form-group mb-4">
                ...
                <select class="form-control" id="timeSlot" name="timeSlot" required>
                    ...
                    <option value="Morning"
                            <c:if test="${formData.timeSlot == 'Morning' || param.timeSlot == 'Morning'}">selected</c:if>>
                        Morning
                    </option>
                    <option value="Afternoon"
                            <c:if test="${formData.timeSlot == 'Afternoon' || param.timeSlot == 'Afternoon'}">selected</c:if>>
                        Afternoon
                    </option>
                    <option value="Evening"
                            <c:if test="${formData.timeSlot == 'Evening' || param.timeSlot == 'Evening'}">selected</c:if>>
                        Evening
                    </option>
                </select>
            </div>
            <div class="form-group mb-4">
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="requiresSpecialist" name="requiresSpecialist"
                           <c:if test="${formData.requiresSpecialist || requiresSpecialist}">checked</c:if>>
                    <label class="form-check-label" for="requiresSpecialist">Yes (+50% price)</label>
                </div>
            </div>
            <div class="total-price-section">
                <div class="price-display" id="priceDisplay">Total Price: <span
                        id="priceValue">${formData.finalPrice != null ? formData.finalPrice : '0'}</span> VND
                </div>
                <input type="hidden" id="finalPrice" name="finalPrice"
                       value="${formData.finalPrice != null ? formData.finalPrice : '0'}">
            </div>
