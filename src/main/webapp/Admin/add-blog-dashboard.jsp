            ...
            <div class="form-container">
                ...
                <form action="add-blog" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="blogSubContent" name="blogSubContent" rows="3" required maxlength="500" placeholder="Nhập tóm tắt ngắn gọn về nội dung bài viết..."></textarea>
                    </div>
                    ...
                    <div class="form-group text-center mt-4">
                        ...
                        <button type="submit" class="btn-hospital btn-primary">
                            <i class="fas fa-save mr-2"></i>Gửi bài viết
                        </button>
                    </div>
                </form>
            </div>
