...
<div class="content" style="flex: 1; margin-left: 260px;">
    <div style="margin-left: 20px">
        <div class="page-header shadow-sm bg-white p-4 mb-4 rounded">
            <h3 class="font-weight-bold text-dark mb-1">Pending Leave Requests</h3>
            <p class="text-muted mb-0">Review and manage all leave requests submitted by doctors.</p>
        </div>
    </div>
    <div class="content-body px-4">
        <div class="hospital-table card-style mb-4">
                ...
                <table class="table table-hover">
                    ...
                    <c:forEach var="dto" items="${pendingLeaveList}">
                        <tr>
                            ...
                            <td>
                                <a href="approve-leave?shiftId=${dto.shiftId}" class="btn btn-primary btn-sm">
                                    Review
                                </a>
                            </td>
                        </tr>
