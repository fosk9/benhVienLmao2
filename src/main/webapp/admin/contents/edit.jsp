...
<div class="container mt-5">
  ...
  <form action="${pageContext.request.contextPath}/admin/contents" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <textarea class="form-control" id="contentValue" name="contentValue">${content.contentValue}</textarea>
    </div>
    <div class="mb-3">
      <label for="isActive" class="form-label">Active</label>
      <select class="form-select" id="isActive" name="isActive">
        <option value="true" ${content.active ? 'selected' : ''}>Active</option>
        <option value="false" ${!content.active ? 'selected' : ''}>Inactive</option>
      </select>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="videoUrl" name="videoUrl" value="${content.videoUrl}">
    </div>
    <div class="mb-3">
      <label for="buttonUrl" class="form-label">Button URL</label>
      <input type="text" class="form-control" id="buttonUrl" name="buttonUrl" value="${content.buttonUrl}">
    </div>
    <div class="mb-3">
